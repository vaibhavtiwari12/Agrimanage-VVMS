  ...
  return (
    <div ref={ref} className="m-4">
      ...
      <div className="receipt-font-size pt-5">
        ...
        {" "}</u>,आज दिनांक {props.data.date} को महाराज वेजिटेबल कंपनी के मालिक (प्रोप्राइटर) <b>श्री इंद्रेश दुबे </b> जी से मटर/टमाटर/अन्य उपज की खेती से संबंधित कार्यों (बीज/खाद/उर्वरक) के लिए {" "}
